...
def main():
    ...
    for cat in target_columns:
        ...
        # Get features
        bucket_dir_name = config["model_dir_name"]
        train_file_name_list = config["features"][cat]["train"]
        test_file_name_list = config["features"][cat]["test"]
        ...
        for i, file_name in enumerate(train_file_name_list):
            ...
            x_test[file_name] = test_pred_value
