...
from encoding_func import target_encoding_lower_limit
from google.cloud import storage


class TargetEncodingLowerLimit(BaseFeature):
    ...
    def make_features(self, df_train_input, df_test_input):
        ...
        for target_col in target_columns:
            ...
            for cat_col in category_columns:
                train_result, test_result = target_encoding_lower_limit(
