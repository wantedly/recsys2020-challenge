...
class AtSignFeatures(BaseFeature):
    ...
    def make_features(self, df_train_input, df_test_input):
        ...
        df_train_features = self._read_features_from_bigquery(
            self.train_text, self.test_text, self.train_table, self.test_table, self.train_table
        )
        df_test_features = self._read_features_from_bigquery(
            self.train_text, self.test_text, self.train_table, self.test_table, self.test_table
        )
